...
# variabiles (w1, w2, w3)
image = imread('./image/butterfly_GT.bmp',is_grayscale=True)
...
print()
'''
w1 = tf.get_variable("w1", [], dtype=tf.int32, initializer=tf.zeros_initializer)
w2 = tf.get_variable("w2", [], dtype=tf.int32, initializer=tf.zeros_initializer)
w3 = tf.get_variable("w3", [], dtype=tf.int32, initializer=tf.zeros_initializer)
'''
